            ...
            {localSettings.provider === 'google' && (
              <div className="space-y-4 p-4 bg-base-100 rounded-lg">
                <InputWithValidation
                  ...
                  onChange={(e) =>
                    setLocalSettings((prev) => ({ ...prev, googleApiKey: e.target.value }))
                  }
                  placeholder="AIza..."
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <ModelSelectWithLoad
                    ...
                    onChange={(e) =>
                      setLocalSettings((prev) => ({ ...prev, openAIImageModel: e.target.value }))
                    }
                    models={
                      availableModels.length > 0
                        ? availableModels.filter((m) => m.includes('imagen'))
            ...
            {localSettings.provider === 'openai' && (
              <div className="space-y-4 p-4 bg-base-100 rounded-lg">
                <InputWithValidation
                  ...
                  onChange={(e) =>
                    setLocalSettings((prev) => ({ ...prev, openAIApiKey: e.target.value }))
                  }
                ...
                <InputWithValidation
                  ...
                  onChange={(e) =>
                    setLocalSettings((prev) => ({ ...prev, openAIBaseUrl: e.target.value }))
                  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <ModelSelectWithLoad
                    ...
                    onChange={(e) =>
                      setLocalSettings((prev) => ({ ...prev, openAITextModel: e.target.value }))
                    }
                    models={
                      availableModels.length > 0
                        ? availableModels
                        : localSettings.openAITextModel
                          ? [localSettings.openAITextModel]
                          : []
                    }
                  ...
                  <ModelSelectWithLoad
                    ...
                    onChange={(e) =>
                      setLocalSettings((prev) => ({ ...prev, openAIVisionModel: e.target.value }))
                    }
                    models={
                      availableModels.length > 0
                        ? availableModels
                        : localSettings.openAIVisionModel
                          ? [localSettings.openAIVisionModel]
                          : []
                    }
                    onLoadModels={loadOpenAIModels}
                  ...
                  <ModelSelectWithLoad
                    ...
                    models={
                      availableModels.length > 0
                        ? availableModels
                        : localSettings.openAIImageModel
                          ? [localSettings.openAIImageModel]
                          : []
                    }
                    onLoadModels={loadOpenAIModels}
        ...
        {activePanel === 'mcp-tools' && (
          <div className="space-y-4">
              ...
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-xs text-text-secondary mt-0.5">
                    Generate images via MCP tool calls
                  </p>
                </div>
                      ...
                      setLocalSettings((prev) => ({
                        ...
                        mcpConfig: {
                          ...
                          imageGeneration: {
                            ...
                            baseUrl:
                              prev.mcpConfig?.imageGeneration?.baseUrl ||
            ...
            {localSettings.mcpConfig &&
              Object.keys(localSettings.mcpConfig)
                .filter((key) => key !== 'supabase' && key !== 'imageGeneration')
                .map((toolKey) => {
                  const tool =
                    localSettings.mcpConfig![toolKey as keyof typeof localSettings.mcpConfig];
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-base-200 rounded-lg p-6 max-w-2xl w-full mx-4">
              ...
              <p className="text-sm text-text-secondary mb-4">
                Enter the JSON configuration for your MCP tool. Required fields:{' '}
                <code className="bg-base-300 px-1 rounded">name</code>,{' '}
                <code className="bg-base-300 px-1 rounded">enabled</code>
              </p>
              <textarea
                value={newMCPJson}
...
// Sub-components
const ProviderButton: React.FC<{ label: string; isActive: boolean; onClick: () => void }> = ({
  label,
  isActive,
  onClick,
}) => (
