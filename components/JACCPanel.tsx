                  ...
                  <button
                    onClick={() => {
                      setSaveTitle(
                        currentAbstractId
                          ? saveTitle
                          : `JACC Abstract - ${new Date().toLocaleDateString()}`
                      );
              ...
              {imageMode === 'standard' ? (
                ...
                <div className="p-4 bg-base-100/50 rounded-lg text-center">
                  ...
                  <p className="text-text-secondary font-medium">
                    Creative mode will generate a cardiovascular figure based on your JACC abstract
                    content.
                  </p>
                </div>
              )}
...
const JACCAnalysisStep: React.FC<{
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-text-secondary">
        Please review and confirm the suggested cardiovascular categories and keywords for your JACC
        abstract.
      </p>
...
const TypeSuggestionStep: React.FC<{
  ...
  <div className="space-y-4">
    ...
    <p className="text-text-secondary">
      Select the JACC abstract type for your cardiovascular research submission.
    </p>
