...
export class DatabaseFallbackService implements DatabaseService {
  ...
  async saveAbstract(
    ...
    try {
      ...
      notificationService.error('Save Failed', 'Failed to save abstract. Please try again.');
      throw error;
    }
  }
  ...
  async loadAbstract(id: string): Promise<SavedAbstract | null> {
    try {
      ...
      notificationService.error('Load Failed', 'Failed to load abstract. Please try again.');
      throw error;
    }
  }
  ...
  async deleteAbstract(id: string): Promise<void> {
    try {
      ...
      notificationService.error('Delete Failed', 'Failed to delete abstract. Please try again.');
      throw error;
    }
  }
  ...
  async updateAbstract(id: string, updates: Partial<SavedAbstract>): Promise<void> {
    try {
      ...
      notificationService.error('Update Failed', 'Failed to update abstract. Please try again.');
      throw error;
    }
  }
