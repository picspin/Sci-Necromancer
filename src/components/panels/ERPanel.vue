          ...
          <div v-if="abstractMode === 'standard'" class="bg-base-100 p-4 rounded-lg">
            ...
            <div class="relative mt-2">
              <textarea
                ...
                aria-label="Input text for ECR abstract generation"
              />
            </div>
          </div>
...
const handleDeepUpdate = async () => {
  ...
  try {
    const refinementPrompt = `Please refine and improve this ECR abstract while maintaining its core message and structure. Focus on:
