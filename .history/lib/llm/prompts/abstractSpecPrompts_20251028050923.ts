...
export const getImpactSynopsisPrompt = (text: string, categories: Category[], keywords: string[]): string => {
  ...
  return `
    ...
    **Guidelines:**
    ...
    -   Use clear, direct language. Avoid AI-like phrases such as "It is worth noting that..." or "Based on the above analysis..."
