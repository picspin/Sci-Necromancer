...
import { getAnalysisPrompt, getAbstractTypeSuggestionPrompt } from './prompts/ismrmPrompts';
import { getImpactSynopsisPrompt, getAbstractByTypePrompt, getCreativeAbstractByTypePrompt } from './prompts/abstractSpecPrompts';
...
export class WorkflowService {
  ...
  constructor(providerName: 'google' | 'openai' = 'google', apiKey?: string) {
    ...
    this.provider = providerName === 'openai' ? openai : gemini;
    this.apiKey = apiKey;
  }
